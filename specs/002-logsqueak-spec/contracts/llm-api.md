...
- When a knowledge block has ANY skip_exists decision, the system will skip that entire knowledge block (no decisions shown for that block) and count it in the summary as "already recorded"
